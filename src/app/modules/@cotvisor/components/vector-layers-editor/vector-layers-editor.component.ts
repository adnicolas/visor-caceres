...
export class VectorLayersEditorComponent extends AbstractParentToolSelectableComponent {
  ...
  public afterChangeActiveMap() {
    ...
    this.map.observableLayerDeleted$
      .pipe(
        // @ADR: Para evitar error en cierre del panel de impresión (Fuente: https://blog.angular-university.io/angular-debugging/)
        delay(0),
    ...
    this.map.observableLayerAdded$
      // @ADR: Para evitar error en apertura del panel de impresión (Fuente: https://blog.angular-university.io/angular-debugging/)
      .pipe(
        delay(0),
        takeUntil(this.unSubscribe))
